...
from core.module import StatusVar, ConfigOption, Connector
...
class CwAwgSwitchLogic(GenericLogic):
    ...
    def on_activate(self):
        ...
        """
        self.ttl_generator().digital_channel_switch(self._ttl_channel, self._cw_selected)
        return
    ...
    def toggle_cw_awg(self, use_cw=None):
        ...
        self.ttl_generator().digital_channel_switch(self._ttl_channel, use_cw)
